...
const GrayLevel: FC<{}> = () => {
  ...
  const showPic = () => {
    ...
    let canvas = document.getElementById('grayLevel');
    ...
    let fragShaderSource = `
      ...
      void main() {
        ...
        // 计算rgb三个分量之和，也就是光度
        float luminance = 0.299*texture.r+0.587*texture.g+0.144*texture.b;

        //，逐片元赋值像素值,RGB相同均为亮度值，用黑白两色表达图片的明暗变化
  ...
  return (
    <div className={styles.container}>
      <canvas id="grayLevel" width="500" height="500" style={{ background: '#aaa' }}></canvas>
    </div>
  );
};
