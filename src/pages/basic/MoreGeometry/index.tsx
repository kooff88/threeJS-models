...
const MoreGeometry: FC<{}> = () => {
  ...
  const showPic = () => {
    ...
    let canvas = document.getElementById('moreGeometry');
  ...
  return (
    <div className={styles.container}>
      <canvas id="moreGeometry" width="500" height="500" style={{ background: '#0d72da' }}></canvas>
    </div>
  );
};

export default MoreGeometry;
